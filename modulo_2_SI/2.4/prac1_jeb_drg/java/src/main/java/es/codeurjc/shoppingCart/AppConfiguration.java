...
public class AppConfiguration {
    ...
    @Bean
    public CartProductUseCase cartProductUseCase(CartProductRepository cartProductRepositoryAdapter){
        return new CartProductUseCaseImpl(cartProductRepositoryAdapter);
    }
}
