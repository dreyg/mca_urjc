...
@Component
public class AllocateDeliveryOrderAction implements Action<OrderStatusEnum, OrderEventEnum> {

	private Logger log = LoggerFactory.getLogger(AllocateDeliveryOrderAction.class);
	...
	@Autowired
	public AllocateDeliveryOrderAction(OrderRepository orderRepository,
