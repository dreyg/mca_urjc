...
public class CityService {
	...
	public CreateCityResponse createCity(CreateCityRequest createCustomerRequest) {
		final City city = new City.Builder()
				                                 .withName(createCustomerRequest.getName())
				                                 .withCodCity(createCustomerRequest.getCodCity())
				                                 .withDeliveryQuantity(createCustomerRequest.getDeliveryQuantity())
				                                 .build();
