...
public class AllocationDeliveryFailureAction implements Action<OrderStatusEnum, OrderEventEnum>{
	...
	@Autowired
	public AllocationDeliveryFailureAction(OrderRepository orderRepository, OrderStreamService orderStreamService, OrderToOrderDtoConverter orderToOrderDtoConverter) {
